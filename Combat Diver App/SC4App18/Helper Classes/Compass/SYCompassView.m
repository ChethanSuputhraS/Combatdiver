...
- (instancetype)initWithFrame:(CGRect)frame radius:(CGFloat)radius
{
    if (self = [super initWithFrame:frame]) {
        ...
        _calibrationColor = [UIColor redColor];
...
- (void)createCalibration
{
    ...
    for (int i = 0; i < 180; i++)
    {
        ...
        if (i == 0) {
            ...
            shapeLayer.strokeColor = CGColorCreateCopyWithAlpha(_calibrationColor.CGColor, 0.9);
        ...
        if (i%15 == 0)
        {
            ...
            if (i < 180)
            {
                ...
                if ([tickText isEqualToString:@"N"] || [tickText isEqualToString:@"W"] || [tickText isEqualToString:@"S"]||[tickText isEqualToString:@"E"])
                {
...
- (void)createPointer
{
    UIImageView *backImg = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, _radius*2, _radius*2)];
    backImg.center = _point;
    [backImg setImage:[UIImage imageNamed:@"seeback.png"]];
    backImg.layer.masksToBounds = YES;
        backImg.layer.cornerRadius = _radius;
        backImg.layer.borderWidth = 0.5;

    //    pointerImageView.backgroundColor = [UIColor whiteColor];
//    [self addSubview:backImg];

    
    UIImageView *pointerImageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, _radius+100, _radius+100)];
//    UIImageView *pointerImageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, _radius*2, _radius*2)];
    ...
    [pointerImageView setImage:[UIImage imageNamed:@"Cmp6.png"]];
//    pointerImageView.backgroundColor = [UIColor whiteColor];
...
- (void)setHorizontalColor:(UIColor *)horizontalColor
{
    ...
    _horizontalView.backgroundColor = [UIColor colorWithCGColor:CGColorCreateCopyWithAlpha(_horizontalColor.CGColor, 0.8)];
}
