...
#define ALERT_TITLE @"Succorfish Installer App"
...
#define globalAppColor [UIColor colorWithRed:0 green:0 blue:0 alpha:1.0]
...
#define global_blueColor [UIColor colorWithRed:27.0/255.0f green:38.0/255.0f blue:70.0/255.0f alpha:1]
