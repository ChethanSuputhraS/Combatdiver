...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated{
    ...
    if(selected)
    {
        ...
        [viewCallout setFrame:CGRectMake(0,0, viewWidth-40, 55)];
        ...
        [viewBGPopUp setFrame:CGRectMake(0,0, viewWidth-40, 45)];
...
//        }
        ...
        lblName= [[UILabel alloc]initWithFrame:CGRectMake(5, 5, viewBGPopUp.frame.size.width-10, 20)];
        ...
        lblAddress= [[UILabel alloc]initWithFrame:CGRectMake(5, 25, viewBGPopUp.frame.size.width-10, 20)];
        lblAddress.font=[UIFont fontWithName:CGRegular size:textSize-4];
