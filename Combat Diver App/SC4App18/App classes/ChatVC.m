...
-(void)setupMainContentView:(int)headerHeights
{
    ...
    tblchat=[[UITableView alloc]initWithFrame:CGRectMake(0, headerHeights, viewWidth, DEVICE_HEIGHT-headerHeights-bottomHeight-1)];
    ...
    viewMessage = [[UIView alloc]initWithFrame:CGRectMake(0, DEVICE_HEIGHT-bottomHeight, viewWidth-0, 80)];
    ...
    lblChatText.frame =CGRectMake(70, 0, viewWidth-120-75, 80);
...
//    txtChat.frame = CGRectMake(75, 0,viewWidth-120-75, 80);
...
//    if (IS_IPAD)
//    {
//        txtChat.font = [UIFont fontWithName:CGRegular size:textSize+2];
//
//    }
//
    ...
    if (IS_IPHONE)
    {
        viewMessage.frame = CGRectMake(0, DEVICE_HEIGHT-bottomHeight, viewWidth-0, 60);
        ...
        txtChat.frame = CGRectMake(65, 0,DEVICE_WIDTH-65-65, 60);
        btnMsgSelec.frame = CGRectMake(0, 0, 65, 60);

        if ([self.isFrom isEqualToString:@"History"])
        {
            img.hidden =YES;
            tblchat.frame = CGRectMake(0, headerHeights, viewWidth, DEVICE_HEIGHT-headerHeights-bottomHeight-40);
        }
    }
}
...
//        long sections =[self.tableArray numberOfSections];
//        long rows = [self.tableArray numberOfMessagesInSection:sections-1];
//
//         NSIndexPath *indexPath3 = [NSIndexPath indexPathForRow:rows-1 inSection:sections-1];
//        tblchat.frame = CGRectMake(0, xx, viewWidth, DEVICE_HEIGHT-xx-bottomHeight-290-80-15);
//                CGPoint offset = CGPointMake(0, DEVICE_HEIGHT-xx-bottomHeight-290-80-15);
//                [tblchat setContentOffset:offset animated:YES];
//        tblchat.frame = CGRectMake(0, xx, viewWidth, DEVICE_HEIGHT-xx-bottomHeight-295-80-20);
...
-(void)textFieldDidEndEditing:(UITextField *)textField
{
    if (textField == txtChat)
    {
//        CGPoint offset = CGPointMake(0, xx);
//        [tblchat setContentOffset:offset animated:YES];
...
{
    if ([lblChatText.text isEqualToString:@"Enter message"])
    {
        FCAlertView *alert = [[FCAlertView alloc] init];
        alert.colorScheme = [UIColor blackColor];
        ...
        [alert showAlertInView:self
                     withTitle:@"Combat Diver"
                  withSubtitle:@"Please select any message first"
    ...
    else
    {
        ...
        else
        {
            ...
            [alert addButton:@"Go to Connect Device" withActionBlock:^{
                NSLog(@"Custom Font Button Pressed");
                ScanVC * scanV = [[ScanVC alloc] init];
    ...
    if (isShow == YES)
    {
        [UIView transitionWithView:myView duration:0.2
                        ...
                        animations:^{
                            ...
                            {
                                viewMessage.frame = CGRectMake(0,DEVICE_HEIGHT-intkeyboardHeight-bottomHeight, viewWidth-0, 80);

                                NSLog(@"hhh is %f",DEVICE_HEIGHT-intkeyboardHeight);
                            }
                            if (myView == tblchat) {
                                tblchat.frame = CGRectMake(0, xx, viewWidth, DEVICE_HEIGHT-xx-bottomHeight-intkeyboardHeight);
    ...
    else
    {
        [UIView transitionWithView:myView duration:0.2
                        ...
                        animations:^{
                            ...
                            if (myView == self->viewMessage)
                            {
                                viewMessage.frame = CGRectMake(0,DEVICE_HEIGHT-bottomHeight, viewWidth-0, 80);
