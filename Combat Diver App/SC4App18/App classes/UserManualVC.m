...
-(void)setMainContentView
{
    ...
    webView.frame = CGRectMake(0, headerhHeight, viewWidth, DEVICE_HEIGHT-headerhHeight);
    ...
    if (IS_IPHONE_X)
    {
        webView.frame = CGRectMake(0, headerhHeight, viewWidth, DEVICE_HEIGHT-headerhHeight-40);
    }
